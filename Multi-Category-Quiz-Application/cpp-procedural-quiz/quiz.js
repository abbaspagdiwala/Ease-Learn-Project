...
const questions = [
  ...
  {
    question: "What is the size of the int data type in most C++ compilers?",
    options: ["2 bytes", "4 bytes", "8 bytes", "Depends on compiler"],
    correct: 3
  },
  {
    question: "Which of the following is used to define a constant in C++?",
    options: ["const", "#define", "Both const and #define", "constant"],
    correct: 2
  },
  {
  ...
  },
  {
    ...
    options: ["function int sum()", "int sum()", "declare sum()", "func sum()"],
    correct: 1
  },
  {
  ...
  },
  {
    ...
    options: ["// for single line, /* */ for multi-line", "# for single line", "<!-- -->", "--"],
    correct: 0
  },
  {
    question: "Which function is used to find the length of a string in C++?",
    options: ["strlen()", "size()", "length()", "Both length() and size()"],
    correct: 3
  },
  {
    question: "Which statement is used to jump to a label in C++?",
